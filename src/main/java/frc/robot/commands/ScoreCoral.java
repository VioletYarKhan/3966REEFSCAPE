        ...
        IntSupplier goalTag
            ...
            if (level.getAsInt() == 4) {
                addCommands(
                    ...
                    new RunCommand(()->drivetrain.driveRobotRelativeChassis(new ChassisSpeeds(0.4, 0, 0)), drivetrain).withTimeout(0.1),
                ...
                addCommands(
                    ...
                    new ParallelCommandGroup(
                        ...
                        new RunCommand(()->drivetrain.driveRobotRelativeChassis(new ChassisSpeeds(-0.4, 0, 0)), drivetrain).withTimeout(0.3)
                    ),
